...
ap.add_argument('-i', '--image', required=True,default='image.jpeg', help='path to the input image')
...
ap.add_argument('-p', '--prototxt', required=True, default='C:\final_project\me_trying\Object-Detection-MobileNet-master\MobileNetSSD_deploy.prototxt.txt',help='path to Caffe deploy prototxt file')
ap.add_argument('-m', '--model', required=True, default='C:\final_project\me_trying\Object-Detection-MobileNet-master\MobileNetSSD_deploy.caffemodel',help='path to the Caffe pre-trained model')
